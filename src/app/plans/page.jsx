            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-4 text-xl text-gray-600">
                        Liberte todo o potencial da sua organização acadêmica.
                    </p>
                </div>
                        ...
                        <div className="pt-6 pb-8 px-6 flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <ul role="list" className="mt-6 space-y-4">
                                    {[
                                        ...
                                        "Acesso ao mapa de atividades",
                                        "Gerador de possíveis grades"
                                    ].map((feature, index) => (
                            ...
                            <div className="mt-8">
                                <button
                                    type="button"
                                    disabled
                                    className="block w-full bg-gray-100 border border-transparent rounded-md py-2 text-sm font-semibold text-gray-400 text-center cursor-not-allowed"
                                >
                                    Plano Atual
                                </button>
                            </div>
