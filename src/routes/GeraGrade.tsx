...
const GeraGrade: React.FC<GeraGradeProps> = ({ cur }) => {
	...
	function altera(a: boolean, b: HTMLInputElement) {
		...
		// Evite manipulações diretas do DOM em React sempre que possível
							...
							<div className="MateriasFeitas-content">
								<div className="periodo-content">
									<div className="lista">
										...
										<br />
										Você&nbsp;
										{"possui " + state.cr.reduce((accumulator, value) => accumulator + value, 0) + " crédito(s)" || " não possui créditos"}
